...
class UCloud_AuthHttpClient
{
    ...
    public function __construct($UCLOUD_PUBLIC_KEY, $UCLOUD_PRIVATE_KEY, $auth, $mimetype = null, $type = HEAD_FIELD_CHECK)
    {
        $this->Type = $type;
        $this->MimeType = $mimetype;
        $this->Auth = UCloud_MakeAuth($UCLOUD_PUBLIC_KEY, $UCLOUD_PRIVATE_KEY, $auth);
    }
